...
The winner is the one that managed to get the target number exactly or
...
..  image:: https://secure.travis-ci.org/fpoirotte/Erebot_Module_Countdown.png
    :alt: unknown
    :target: http://travis-ci.org/#!/fpoirotte/Erebot_Module_Countdown/
